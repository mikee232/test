...
function onCreate()
        ...
        makeLuaSprite('timmys room', 'fondo-zero', -800, -670);
	scaleLuaSprite('timmys room', 2.0, 2.1);

	makeLuaSprite('zero', 'zero', 940, 20);
	setObjectCamera('zero', 'other');
	scaleObject('zero', 1, 1);
	addLuaSprite('zero', true);
